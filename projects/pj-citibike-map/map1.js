// Citibike September 2020 Starts

// mapbox info
mapboxgl.accessToken = 'pk.eyJ1Ijoic21lcnJpYW0iLCJhIjoiY2w0YnNibXZjMXAxdDNvcGk4eDlzMXI2bCJ9.hxvKaB0_QUg29LlE-7mwhQ';
var map1 = new mapboxgl.Map({
    ...
    map1.on("load", function () {
      map1.addLayer(
          {
          id: "sep_2020_start_points",
          type: "circle",
          source: {
              type: "geojson",
              data: "data/citibike_sep_2020_start_station_citiGeo.geojson",
          },
    ...
    // }, 'waterway-shadow');
      ...
      map1.on('click', 'sep_2020_start_points', function (e) {
    ...
    map1.on('mouseenter', 'sep_2020_start_points', function () {
        map1.getCanvas().style.cursor = 'pointer';
    });
    map1.on('mouseleave', 'sep_2020_start_points', function () {
