...
// mapbox info
mapboxgl.accessToken = 'pk.eyJ1Ijoic21lcnJpYW0iLCJhIjoiY2w0MnluaXAxNG5qZzNicDd4MWExdmJ1byJ9.2lx0PfgSTNpEuMy8O6Lc6A';
var map2 = new mapboxgl.Map({
    container: 'map2',
    style: 'mapbox://styles/smerriam/cl3uaa5p1001g14pbznxe4cxm',
    zoom: 3.2,
    maxZoom: 9,
    minZoom: 3,
    center: [-99, 38],
    ...
    map2.on("load", function () {
      map2.addLayer(
          ...
          //circle radius info determines the size of the points aka the vote share
          paint: {
              "circle-radius": [
                "interpolate",
                ["linear"],
              ...
              "circle-stroke-color": "#ffffff", //change to #ffffff
              "circle-opacity": [
              "step",
              ["get", "WnrPerc"],
              0.3,
